...
VALUES (1, N'Address 1', N'Address 2', 0, '2020-08-16T18:19:11.9331056-04:00', NULL, 1, 1, 0, '2020-08-16T18:19:11.9331056-04:00', N'Business Name', N'zz', N'zzzzz');
IF EXISTS (SELECT * FROM [sys].[identity_columns] WHERE [name] IN (N'Id', N'Address1', N'Address2', N'CreatedBy', N'CreatedDate', N'Description', N'IsActive', N'IsVisible', N'LastModifiedBy', N'LastModifiedDate', N'Name', N'State', N'ZipCode') AND [object_id] = OBJECT_ID(N'[Businesses]'))
...
VALUES (1, 0, '2020-08-16T18:19:11.9331056-04:00', N'New Group', 1, 1, 0, '2020-08-16T18:19:11.9331056-04:00', 0);
IF EXISTS (SELECT * FROM [sys].[identity_columns] WHERE [name] IN (N'Id', N'CreatedBy', N'CreatedDate', N'Description', N'IsActive', N'IsVisible', N'LastModifiedBy', N'LastModifiedDate', N'SortId') AND [object_id] = OBJECT_ID(N'[Groups]'))
...
VALUES (1, 0, '2020-08-16T18:19:11.9331056-04:00', NULL, 1, 1, 0, '2020-08-16T18:19:11.9331056-04:00', N'home', 0, 1, N'Home', N'1,2,3');
IF EXISTS (SELECT * FROM [sys].[identity_columns] WHERE [name] IN (N'Id', N'CreatedBy', N'CreatedDate', N'IconName', N'IsActive', N'IsVisible', N'LastModifiedBy', N'LastModifiedDate', N'Link', N'MainMenuId', N'SortId', N'Title', N'UserRoles') AND [object_id] = OBJECT_ID(N'[Menus]'))
...
IF EXISTS (SELECT * FROM [sys].[identity_columns] WHERE [name] IN (N'Id', N'CreatedBy', N'CreatedDate', N'IconName', N'IsActive', N'IsVisible', N'LastModifiedBy', N'LastModifiedDate', N'Link', N'MainMenuId', N'SortId', N'Title', N'UserRoles') AND [object_id] = OBJECT_ID(N'[Menus]'))
    SET IDENTITY_INSERT [Menus] ON;
INSERT INTO [Menus] ([Id], [CreatedBy], [CreatedDate], [IconName], [IsActive], [IsVisible], [LastModifiedBy], [LastModifiedDate], [Link], [MainMenuId], [SortId], [Title], [UserRoles])
VALUES (2, 0, '2020-08-16T18:19:11.9331056-04:00', NULL, 1, 1, 0, '2020-08-16T18:19:11.9331056-04:00', N'account', 0, 2, N'Account', N'1,2,3');
IF EXISTS (SELECT * FROM [sys].[identity_columns] WHERE [name] IN (N'Id', N'CreatedBy', N'CreatedDate', N'IconName', N'IsActive', N'IsVisible', N'LastModifiedBy', N'LastModifiedDate', N'Link', N'MainMenuId', N'SortId', N'Title', N'UserRoles') AND [object_id] = OBJECT_ID(N'[Menus]'))
    SET IDENTITY_INSERT [Menus] OFF;
...
IF EXISTS (SELECT * FROM [sys].[identity_columns] WHERE [name] IN (N'Id', N'CreatedBy', N'CreatedDate', N'IconName', N'IsActive', N'IsVisible', N'LastModifiedBy', N'LastModifiedDate', N'Link', N'MainMenuId', N'SortId', N'Title', N'UserRoles') AND [object_id] = OBJECT_ID(N'[Menus]'))
    SET IDENTITY_INSERT [Menus] ON;
INSERT INTO [Menus] ([Id], [CreatedBy], [CreatedDate], [IconName], [IsActive], [IsVisible], [LastModifiedBy], [LastModifiedDate], [Link], [MainMenuId], [SortId], [Title], [UserRoles])
VALUES (3, 0, '2020-08-16T18:19:11.9331056-04:00', NULL, 1, 1, 0, '2020-08-16T18:19:11.9331056-04:00', N'transaction', 0, 3, N'Transaction', N'1,2,3');
IF EXISTS (SELECT * FROM [sys].[identity_columns] WHERE [name] IN (N'Id', N'CreatedBy', N'CreatedDate', N'IconName', N'IsActive', N'IsVisible', N'LastModifiedBy', N'LastModifiedDate', N'Link', N'MainMenuId', N'SortId', N'Title', N'UserRoles') AND [object_id] = OBJECT_ID(N'[Menus]'))
    SET IDENTITY_INSERT [Menus] OFF;
...
IF EXISTS (SELECT * FROM [sys].[identity_columns] WHERE [name] IN (N'Id', N'CreatedBy', N'CreatedDate', N'IconName', N'IsActive', N'IsVisible', N'LastModifiedBy', N'LastModifiedDate', N'Link', N'MainMenuId', N'SortId', N'Title', N'UserRoles') AND [object_id] = OBJECT_ID(N'[Menus]'))
    SET IDENTITY_INSERT [Menus] ON;
INSERT INTO [Menus] ([Id], [CreatedBy], [CreatedDate], [IconName], [IsActive], [IsVisible], [LastModifiedBy], [LastModifiedDate], [Link], [MainMenuId], [SortId], [Title], [UserRoles])
VALUES (4, 0, '2020-08-16T18:19:11.9331056-04:00', NULL, 1, 1, 0, '2020-08-16T18:19:11.9331056-04:00', N'report', 0, 4, N'Reports', N'1,2,3');
IF EXISTS (SELECT * FROM [sys].[identity_columns] WHERE [name] IN (N'Id', N'CreatedBy', N'CreatedDate', N'IconName', N'IsActive', N'IsVisible', N'LastModifiedBy', N'LastModifiedDate', N'Link', N'MainMenuId', N'SortId', N'Title', N'UserRoles') AND [object_id] = OBJECT_ID(N'[Menus]'))
    SET IDENTITY_INSERT [Menus] OFF;
...
IF EXISTS (SELECT * FROM [sys].[identity_columns] WHERE [name] IN (N'Id', N'CreatedBy', N'CreatedDate', N'IconName', N'IsActive', N'IsVisible', N'LastModifiedBy', N'LastModifiedDate', N'Link', N'MainMenuId', N'SortId', N'Title', N'UserRoles') AND [object_id] = OBJECT_ID(N'[Menus]'))
    SET IDENTITY_INSERT [Menus] ON;
INSERT INTO [Menus] ([Id], [CreatedBy], [CreatedDate], [IconName], [IsActive], [IsVisible], [LastModifiedBy], [LastModifiedDate], [Link], [MainMenuId], [SortId], [Title], [UserRoles])
VALUES (5, 0, '2020-08-16T18:19:11.9331056-04:00', NULL, 1, 1, 0, '2020-08-16T18:19:11.9331056-04:00', N'code', 0, 5, N'Code System', N'1,2,3');
IF EXISTS (SELECT * FROM [sys].[identity_columns] WHERE [name] IN (N'Id', N'CreatedBy', N'CreatedDate', N'IconName', N'IsActive', N'IsVisible', N'LastModifiedBy', N'LastModifiedDate', N'Link', N'MainMenuId', N'SortId', N'Title', N'UserRoles') AND [object_id] = OBJECT_ID(N'[Menus]'))
    SET IDENTITY_INSERT [Menus] OFF;
...
IF EXISTS (SELECT * FROM [sys].[identity_columns] WHERE [name] IN (N'Id', N'CreatedBy', N'CreatedDate', N'IconName', N'IsActive', N'IsVisible', N'LastModifiedBy', N'LastModifiedDate', N'Link', N'MainMenuId', N'SortId', N'Title', N'UserRoles') AND [object_id] = OBJECT_ID(N'[Menus]'))
    SET IDENTITY_INSERT [Menus] ON;
INSERT INTO [Menus] ([Id], [CreatedBy], [CreatedDate], [IconName], [IsActive], [IsVisible], [LastModifiedBy], [LastModifiedDate], [Link], [MainMenuId], [SortId], [Title], [UserRoles])
VALUES (6, 0, '2020-08-16T18:19:11.9331056-04:00', NULL, 1, 1, 0, '2020-08-16T18:19:11.9331056-04:00', N'setting', 0, 6, N'Setting', N'1,2,3');
IF EXISTS (SELECT * FROM [sys].[identity_columns] WHERE [name] IN (N'Id', N'CreatedBy', N'CreatedDate', N'IconName', N'IsActive', N'IsVisible', N'LastModifiedBy', N'LastModifiedDate', N'Link', N'MainMenuId', N'SortId', N'Title', N'UserRoles') AND [object_id] = OBJECT_ID(N'[Menus]'))
    SET IDENTITY_INSERT [Menus] OFF;
...
IF EXISTS (SELECT * FROM [sys].[identity_columns] WHERE [name] IN (N'Id', N'CreatedBy', N'CreatedDate', N'IconName', N'IsActive', N'IsVisible', N'LastModifiedBy', N'LastModifiedDate', N'Link', N'MainMenuId', N'SortId', N'Title', N'UserRoles') AND [object_id] = OBJECT_ID(N'[Menus]'))
    SET IDENTITY_INSERT [Menus] ON;
INSERT INTO [Menus] ([Id], [CreatedBy], [CreatedDate], [IconName], [IsActive], [IsVisible], [LastModifiedBy], [LastModifiedDate], [Link], [MainMenuId], [SortId], [Title], [UserRoles])
VALUES (7, 0, '2020-08-16T18:19:11.9331056-04:00', NULL, 1, 1, 0, '2020-08-16T18:19:11.9331056-04:00', N'tool', 0, 7, N'Tools', N'1,2,3');
IF EXISTS (SELECT * FROM [sys].[identity_columns] WHERE [name] IN (N'Id', N'CreatedBy', N'CreatedDate', N'IconName', N'IsActive', N'IsVisible', N'LastModifiedBy', N'LastModifiedDate', N'Link', N'MainMenuId', N'SortId', N'Title', N'UserRoles') AND [object_id] = OBJECT_ID(N'[Menus]'))
    SET IDENTITY_INSERT [Menus] OFF;
...
IF EXISTS (SELECT * FROM [sys].[identity_columns] WHERE [name] IN (N'Id', N'CreatedBy', N'CreatedDate', N'IconName', N'IsActive', N'IsVisible', N'LastModifiedBy', N'LastModifiedDate', N'Link', N'MainMenuId', N'SortId', N'Title', N'UserRoles') AND [object_id] = OBJECT_ID(N'[Menus]'))
    SET IDENTITY_INSERT [Menus] ON;
INSERT INTO [Menus] ([Id], [CreatedBy], [CreatedDate], [IconName], [IsActive], [IsVisible], [LastModifiedBy], [LastModifiedDate], [Link], [MainMenuId], [SortId], [Title], [UserRoles])
VALUES (8, 0, '2020-08-16T18:19:11.9331056-04:00', NULL, 1, 1, 0, '2020-08-16T18:19:11.9331056-04:00', N'menu', 5, 1, N'Menu', N'1,2,3');
IF EXISTS (SELECT * FROM [sys].[identity_columns] WHERE [name] IN (N'Id', N'CreatedBy', N'CreatedDate', N'IconName', N'IsActive', N'IsVisible', N'LastModifiedBy', N'LastModifiedDate', N'Link', N'MainMenuId', N'SortId', N'Title', N'UserRoles') AND [object_id] = OBJECT_ID(N'[Menus]'))
    SET IDENTITY_INSERT [Menus] OFF;
...
IF EXISTS (SELECT * FROM [sys].[identity_columns] WHERE [name] IN (N'Id', N'CreatedBy', N'CreatedDate', N'IconName', N'IsActive', N'IsVisible', N'LastModifiedBy', N'LastModifiedDate', N'Link', N'MainMenuId', N'SortId', N'Title', N'UserRoles') AND [object_id] = OBJECT_ID(N'[Menus]'))
    SET IDENTITY_INSERT [Menus] ON;
INSERT INTO [Menus] ([Id], [CreatedBy], [CreatedDate], [IconName], [IsActive], [IsVisible], [LastModifiedBy], [LastModifiedDate], [Link], [MainMenuId], [SortId], [Title], [UserRoles])
VALUES (9, 0, '2020-08-16T18:19:11.9331056-04:00', NULL, 1, 1, 0, '2020-08-16T18:19:11.9331056-04:00', N'role', 6, 1, N'Role', N'1,2,3');
IF EXISTS (SELECT * FROM [sys].[identity_columns] WHERE [name] IN (N'Id', N'CreatedBy', N'CreatedDate', N'IconName', N'IsActive', N'IsVisible', N'LastModifiedBy', N'LastModifiedDate', N'Link', N'MainMenuId', N'SortId', N'Title', N'UserRoles') AND [object_id] = OBJECT_ID(N'[Menus]'))
    SET IDENTITY_INSERT [Menus] OFF;
...
IF EXISTS (SELECT * FROM [sys].[identity_columns] WHERE [name] IN (N'Id', N'CreatedBy', N'CreatedDate', N'IconName', N'IsActive', N'IsVisible', N'LastModifiedBy', N'LastModifiedDate', N'Link', N'MainMenuId', N'SortId', N'Title', N'UserRoles') AND [object_id] = OBJECT_ID(N'[Menus]'))
    SET IDENTITY_INSERT [Menus] ON;
INSERT INTO [Menus] ([Id], [CreatedBy], [CreatedDate], [IconName], [IsActive], [IsVisible], [LastModifiedBy], [LastModifiedDate], [Link], [MainMenuId], [SortId], [Title], [UserRoles])
VALUES (10, 0, '2020-08-16T18:19:11.9331056-04:00', NULL, 1, 1, 0, '2020-08-16T18:19:11.9331056-04:00', N'user', 6, 2, N'User', N'1,2,3');
IF EXISTS (SELECT * FROM [sys].[identity_columns] WHERE [name] IN (N'Id', N'CreatedBy', N'CreatedDate', N'IconName', N'IsActive', N'IsVisible', N'LastModifiedBy', N'LastModifiedDate', N'Link', N'MainMenuId', N'SortId', N'Title', N'UserRoles') AND [object_id] = OBJECT_ID(N'[Menus]'))
    SET IDENTITY_INSERT [Menus] OFF;
...
VALUES (1, 0, '2020-08-16T18:19:11.9265922-04:00', N'Admin', 1, 1, 0, '2020-08-16T18:19:11.9331056-04:00');
IF EXISTS (SELECT * FROM [sys].[identity_columns] WHERE [name] IN (N'Id', N'CreatedBy', N'CreatedDate', N'Description', N'IsActive', N'IsVisible', N'LastModifiedBy', N'LastModifiedDate') AND [object_id] = OBJECT_ID(N'[Roles]'))
...
IF EXISTS (SELECT * FROM [sys].[identity_columns] WHERE [name] IN (N'Id', N'CreatedBy', N'CreatedDate', N'Description', N'IsActive', N'IsVisible', N'LastModifiedBy', N'LastModifiedDate') AND [object_id] = OBJECT_ID(N'[Roles]'))
    SET IDENTITY_INSERT [Roles] ON;
INSERT INTO [Roles] ([Id], [CreatedBy], [CreatedDate], [Description], [IsActive], [IsVisible], [LastModifiedBy], [LastModifiedDate])
VALUES (2, 0, '2020-08-16T18:19:11.9331056-04:00', N'User', 1, 1, 0, '2020-08-16T18:19:11.9331056-04:00');
IF EXISTS (SELECT * FROM [sys].[identity_columns] WHERE [name] IN (N'Id', N'CreatedBy', N'CreatedDate', N'Description', N'IsActive', N'IsVisible', N'LastModifiedBy', N'LastModifiedDate') AND [object_id] = OBJECT_ID(N'[Roles]'))
    SET IDENTITY_INSERT [Roles] OFF;
...
IF EXISTS (SELECT * FROM [sys].[identity_columns] WHERE [name] IN (N'Id', N'CreatedBy', N'CreatedDate', N'Description', N'IsActive', N'IsVisible', N'LastModifiedBy', N'LastModifiedDate') AND [object_id] = OBJECT_ID(N'[Roles]'))
    SET IDENTITY_INSERT [Roles] ON;
INSERT INTO [Roles] ([Id], [CreatedBy], [CreatedDate], [Description], [IsActive], [IsVisible], [LastModifiedBy], [LastModifiedDate])
VALUES (3, 0, '2020-08-16T18:19:11.9331056-04:00', N'Viewer', 1, 1, 0, '2020-08-16T18:19:11.9331056-04:00');
IF EXISTS (SELECT * FROM [sys].[identity_columns] WHERE [name] IN (N'Id', N'CreatedBy', N'CreatedDate', N'Description', N'IsActive', N'IsVisible', N'LastModifiedBy', N'LastModifiedDate') AND [object_id] = OBJECT_ID(N'[Roles]'))
    SET IDENTITY_INSERT [Roles] OFF;
...
VALUES (N'20200816221912_inital_db_1', N'2.2.6-servicing-10079');
